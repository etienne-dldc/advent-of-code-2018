        ...
        */
        ...
        carts.forEach((cart, index) => {
            ...
            const hasCollision = carts.find((colCart, colIndex) => {
                return colCart.crached !== true && colIndex !== index && colCart.x === nextCoord.x && colCart.y === nextCoord.y
            })
            if (hasCollision && !collision) {
                // collision = { x: nextCoord.x, y: nextCoord.y };
                cart.crached = true;
                hasCollision.crached = true;
        ...
        carts = carts.filter(cart => cart.crached !== true);
